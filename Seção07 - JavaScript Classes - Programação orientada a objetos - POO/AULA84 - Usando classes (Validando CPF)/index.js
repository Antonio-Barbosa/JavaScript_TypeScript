class ValidaCPF {
    ...
    static geraDigito(cpfParcial) { // Uso essa função como static, pois não uso nenhum this, logo não preciso de nada da instância.
        let total = 0;
...
const validaCPF = new ValidaCPF('479.652.828-50');
